    ...
    <div class="container">
      <div class="area_page page_800">
        <section class="area_back_page">
          <a class="btn_line_navy" href="{{ route('admin.information.detail', $information)}}"></a>
        </section>
        <div class="body_page">
          <section class="area_user_detail">
            <div class="layout_main">
              <div class="box">
                <div class="head_box">
                  <div class="text">
                    <p class="h1">お知らせを編集する</p>
                    <p class="description">お知らせ内容を入力してください</p>
                    <p class="description">「<span style="color: #FF0000;">*</span>」は必須項目ですので必ず入力してください。</p>
                  </div>
                </div>
                <div class="body_box">
                  {!! Form::model($information, ['url' => route('admin.information.edit', $information), 'method' => 'post','enctype'=>'multipart/form-data','files'=> true]) !!}
                  <!-- フォームエリア -->
                      ...
                      <div class="form_data">
                        <div class="wrap_input">
                          <div class="wrap_img">
                            ...
                            {!! Form::hidden('old_image_path[]', isset($information->pic_path) ? $information->id : '' ) !!}
                            <label for="input_eyecatch_main" id="file_preview_main" style="background: url({{ $information->url }})"></label>
                          </div>
                        </div>
                        @error('pic_path')
                          <span class=" invalid-feedback" role="alert">
                    ...
                    <li class="required">
                      ...
                      <div class="form_data">
                        <div class="wrap_input_140 wrap_calendar">
                          {!! Form::datetime('release_date', null, ['placeholder' => 'YYYY/MM/DD', "class"=>"datepicker", "format"=>"Y.m.d","autocomplete"=>"off"]) !!}
                        </div>
                        @error('release_date')
                          <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                  ...
                  <div class="btnarea_form">
                    <a href="{{ route('admin.information.detail', $information)}}" class="btn_gray">キャンセル</a>

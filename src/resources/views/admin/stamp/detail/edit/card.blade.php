 ...
 <section class="body_main">
  <div class="container">
    <div class="box box_600">
      <div class="head_box">
        <div class="text">
          <p class="h1">スタンプカードを編集する</p>
          <p class="description">スタンプカード情報を入力してください</p>
          <p class="description">「<span style="color: #FF0000;">*</span>」は必須項目ですので必ず入力してください。</p>
        </div>
      </div>
      <div class="body_box">
        {!! Form::model($stamp_card, ['url' => route('admin.stamp.card_edit', $stamp_card), 'method' => 'post','enctype'=>'multipart/form-data','files'=> true]) !!}
       ...
       <!-- 利用期間 -->
        ...
        <div class="btnarea_form">
          ...
          {{ Form::button('編集する', ['type' => 'submit' ,'class' => 'btn_']) }}
        </div>
        {!! Form::close() !!}
      </div>
    </div>

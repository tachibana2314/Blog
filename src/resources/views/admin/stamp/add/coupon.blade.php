  ...
  <section class="body_main">
    <div class="container">
      <div class="box box_600">
        <div class="head_box">
          <div class="text">
            <p class="h1">スタンプクーポンを追加する</p>
            <p class="description">スタンプクーポン情報を入力してください</p>
            <p class="description">「<span style="color: #FF0000;">*</span>」は必須項目ですので必ず入力してください。</p>
          </div>
        </div>
        <div class="body_box">
          {{ Form::open(['route'=>'admin.stamp.addCoupon', 'method'=>'post','enctype'=>'multipart/form-data','files'=> true]) }}
            ...
            <li class="required">
              ...
              <div class="form_data">
                <div class="wrap_input">
                  {!! Form::text('title', null, ['placeholder' => 'クーポン名を入力', 'rows' => 3]) !!}
                </div>
                @error('title')

@extends('admin.element.register')
  ...
  <section class="body_main">
    <div class="container">
      <div class="box box_600">
        <div class="head_box">
          <div class="text">
            <p class="h1">管理者登録情報入力する</p>
            <p class="description">管理者情報を入力してください</p>
          </div>
        </div>
        <div class="body_box">
          {{ Form::open(['route'=>['admin.member.register',$email_token], 'method'=>'post']) }}
          <!-- フォームエリア -->
          <ul class="list_form">
            <!-- 氏名 -->
            <li class="required">
            ...
            <li class="required">
              ...
              <div class="form_data">
                <div class="wrap_input">
                  {{ Form::text('email',$admin['email'],['placeholder'=>'メールアドレス','readonly'=>true]) }}
                </div>
              </div>
            </li>
            <!-- 部署 -->
            <li>
              <div class="form_head">
                <p class="ttl" style="width:150px;">　部署</p>
              </div>
              <div class="form_data">
                <div class="wrap_input">
            ...
            <li>
              <div class="form_head">
                <p class="ttl" style="width:150px;">　役職</p>
              </div>
              <div class="form_data">
                <div class="wrap_input">
            ...
            <li class="required">
              <div class="form_head">
                <p class="ttl" style="width:150px;">仮パスワード</p>
              </div>
              <div class="form_data">
                <div class="wrap_input">
                  {{ Form::password('old_password',['placeholder'=>'メールに記載の仮パスワードを入力してください']) }}
                </div>
                @error('old_password')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>

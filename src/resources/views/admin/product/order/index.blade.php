          ...
          <section class="body_page">
            <div class="layout col">
              ...
              <div class="box">
                <div class="head_box col">
                  ...
                  <div class="area_ttl">
                    <div class="wrap_input wrap_select">
                      {!! Form::select('m_product_category_id', $m_product_category, $category->id, ['placeholder' => 'カテゴリーを選択', 'onChange'=>'submit()'])!!}
                    </div>
                  </div>
                  {{ Form::close() }}
                ...
                {{ Form::open(['route' => 'admin.product.orderStore']) }}
                <div class="body_box">
                  <div class="area_slide">
                    <ul class="list_slide" id="sortableArea">
                      @foreach ($products as $product)
                        @include('admin.product.order._product', ['product' => $product])
                      @endforeach
                    </ul>
                  </div>
                </div>

<div class="p-remodal remodal" data-remodal-id="js-modal__contact_delete_{{$contact->id}}" data-remodal-options="hashTracking:true;">
  ...
  <div class="p-remodal__layout">
    ...
    <div class="p-remodal__foot">
      {{ Form::open(['route' => ['admin.contact.delete', $contact], 'method' => 'delete']) }}

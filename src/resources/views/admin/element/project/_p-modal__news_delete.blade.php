<div class="p-remodal remodal" data-remodal-id="js-modal__news_delete" data-remodal-options="hashTracking:true;">
  ...
  <div class="p-remodal__layout">
    ...
    <div class="p-remodal__foot">
      {{ Form::open(['route' => ['admin.content.delete', $content], 'method' => 'delete']) }}

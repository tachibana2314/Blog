<section class="remodal remodal_800" data-remodal-id="modal_delete_coupon">
    ...
    <section class="box">
      ...
      <div class="head_box">
        <div class="area_ttl center">
          <p class="ttl h3">{{$coupon->title}}を削除</p>
        </div>
      </div>
      <div class="body_box">
        <div class="area_ttl center">
      ...
      <div class="foot_box">
        <div class="btnarea_center">
          ...
          {{ Form::open(['route' => ['admin.coupon.delete', $coupon], 'method' => 'delete']) }}
